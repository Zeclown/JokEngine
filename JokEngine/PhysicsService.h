...
namespace Jokengine
{
	...
	{	
		public:
			...
			virtual b2Fixture* RegisterFixtureBox(b2Body *body, Collider* col, glm::vec2 size = glm::vec2(1, 1), glm::vec2 offset = glm::vec2(0, 0), std::string layerName = "default")=0;
			virtual b2Fixture* RegisterFixtureCircle(b2Body *body, Collider* col, GLfloat radius = 1, glm::vec2 offset = glm::vec2(0, 0), std::string layerName = "default")=0;
			...
			virtual void Raycast(glm::vec2 origin, glm::vec2 direction, GLfloat maxDistance, uint16 physicMask)=0;
			virtual GLboolean Raycast(glm::vec2 origin, glm::vec2 direction,RaycastHit &output, GLfloat maxDistance, uint16 physicMask)=0;
